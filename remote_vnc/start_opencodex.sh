...
container_command_path="${container_codex_standalone_directory}/current/bin:/usr/local/cuda/bin:/opt/matlab/R2024b/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
